            ...
            if (mysqli_num_rows($maxid) > 0) {
                ...
                if ($result) {
                    if (mysqli_num_rows($result) > 0) {
                        if (mysqli_fetch_assoc($result)['Status_speedrun'] == 'Completed') {

                            echo "<script> window.location.href = 'timescape.php'; </script>";
                        }
                    }
                }
            }
...
<head>
    ...
    <title>Speed Run | Swift Fingers | Ananta</title>
...
<body data-spy="scroll" data-target="#navbar1" data-offset="60" style="background-image: linear-gradient(to bottom, #0a0a0a, #000000);">
    <div class="title" style="height: 100vh; width: 100vw;">
        <h1 class="col-12 text-primary text-center"><span class="ion ion-md-speedometer"></span></h1>
        <h1 class="col-12 text-center">Round 1</h1>
        <h1 class="col-12 text-center">Speed Run</h1>
    </div>
    <main style="width: 100%; background-image: linear-gradient(to bottom, #0a0a0a, #000000); padding-bottom: 0.9rem; min-height: 100vh; margin: auto 0;">
    ...
    <script>
        ...
        function loadParagraph() {
            ...
            paragraphs[0].split(" ").forEach(word => {
                let div = ''
        ...
        function initTyping() {
            ...
            if (charIndex < characters.length - 1) {
                        ...
                        <div class="row mt-0 py-5">
                            <div class="col-12 my-auto mt-0 py-5">
                                        ...
                                        <div class="content-box">
                                            <div class="content"
                                                ...
                                                <div class="wpm d-flex align-items-center flex-column"
                                                    ...
                                                    <label style="text-align: center; display: block; height: 20px;">${Math.round(((charIndex - wrongWords) / 5) / (timer-18) * 60)}</label>
                                                ...
                                                <div class="time d-flex align-items-center flex-column">
                                                    ...
                                                    <label style="text-align: center; display: block; height: 20px;">${Math.floor(((timer-18) / 60)) + ":" + ((timer-18) % 60)}</label>
                                ...
                                <div class="col-12 text-center nxt">
                                    <a class="btn btn-primary" href="timescape.php">Next Round</a>
                                </div>
                            </div>
                        </div>
                    </section>`
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: {
                        wpm: String((((charIndex - wrongWords) / 5) / (timer-18) * 60).toFixed(4)),
